...
export default class Server {
	...
	constructor(serverOptions: ServerOptions) {
		...
		this.tagsController = new TagsController(this.sql);

		this.authController = new AuthController(this.sql);
		this.userController = new UserController(this.sql);
		this.postController = new PostController(this.sql);
		this.commentController = new CommentController(this.sql);
		this.authController.registerRoutes(this.router);
		this.userController.registerRoutes(this.router);
		this.postController.registerRoutes(this.router);
		this.commentController.registerRoutes(this.router);
		this.tagsController.registerRoutes(this.router);
	...
	start = async () => {
		...
		await Tag.initializeDefaultTags(this.sql)
